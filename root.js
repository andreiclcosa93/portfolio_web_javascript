...
const stickyElement = (x, y, hoveredEl) => {
    ...
    if (hoveredEl.classList.contains("sticky")) {
        ...
        hoveredEl.style.cssText = `top: ${y}px; left: ${x}`;
...
const aboutMeTextContent = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500.";
